...
<div id="Container">
 ...
 <c:if test="${sessionScope.role!='null'}">
  ...
  <div id="footer2_">
   ...
   <center>
   <h3 >View <c:out value="${sessionScope.CITY}"></c:out> Bus Schedule Information<br /></h3>
  </center>
  <center>
   <font color="red"><b>
  ...
  <center>
    <form action="<%=request.getContextPath()%>/ViewCityBusScheduleInfo.jsp">
     <table>
           ...
           BusBean bb;
            while(it.hasNext())
            {
             ...
             System.out.println(bb.getRootid()+""+bb.getFrom());
					%>
					<option value="<%=bb.getRootid()%>"><%=bb.getRootid() %>[<%=bb.getFrom()%>--<%=bb.getTo() %>] </option>
