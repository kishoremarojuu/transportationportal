...
<div id="Container">
  ...
  <center>
    <form action="<%=request.getContextPath() %>/viewMMTSTimings.jsp" name="root">
     <table>
      <tr><td><font color="#E6E6FA"size="4">Select Route</font></td><td><select name="route" onchange="javascript:if(document.root.route.value==''){alert('Select Route');}  {location.href='./MmtsRoutes1.jsp?route='+document.root.route.value;}">
