...
<div id="Container">
  ...
  <div id="footer2_">
   ...
   <center>
   <h3 >Add <c:out value="${sessionScope.CITY}"></c:out> Traffic Analyzer Info<br /></h3>
  </center>
  <center>
   <font color="red"><b>
  ...
  <center>
    ...
    <%}
          ...
          <tr><td><font color="#E6E6FA"size="4"></font></td><td><a href="<%=request.getContextPath()%>/AddNewTrafficInfo.jsp">AddNewTrafficInfo</a></td></tr>
